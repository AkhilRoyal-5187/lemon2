...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-auto w-max items-center justify-center rounded-md bg-transparent px-3 py-2 text-lg font-bold transition-colors focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[state=open]:bg-accent/50"
)
